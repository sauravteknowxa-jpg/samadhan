...
function Home() {
 const settings = {
    ...
    return (
        <>
            ...
            <div className="w-full">
                <div className=" flex flex-col lg:flex-row gap-4 bg-slate-50 px-4 sm:px-6 md:px-12 lg:px-30
  py-2 sm:py-4 lg:py-8 w-full">
                    ...
                    <div className="relative overflow-hidden flex items-stretch justify-center    lg:w-1/2 w-full">
                        ...
                        <img src="/image/samadhantra-hero-img.png" alt="" className="relative w-full object-contain " />
                        <div>
                            <a href="https://www.youtube.com/">

                            </a>
                        </div>
                        <img src="/image/bg-shape.png" alt="" className="hidden lg:block absolute bottom-1/2 translate-y-1/2  left-0  z-0 w-[13%] max-h-[450px] object-cover" />
                    </div>
                </div>
            </div>
            ...
            {/* section3 */}
            <div className="w-full ">
                <div className=" flex flex-col md:flex-row gap-8  p-4 sm:px-6 md:px-10 lg:px-24 pt-24 pb-20  w-full">
  ...
  <div className="bg-[#f8f8f49d] text-black text-xl flex items-center gap-4 p-4 rounded-xl w-full h-20">
    ...
    <span className="leading-snug break-words text-xl font-semibold">
      Service & Product Provider & Vendor Partners
            ...
            {/* section4 */}
            <div className="flex flex-col items-center justify-center pt-24 pb-20 w-full">
                <div className="flex flex-col items-center justify-center p-4 sm:px-6 md:px-10 lg:px-32 text-center">
                    <span className="text-[#0A5585]  text-xl sm:text-2xl font-bold">
                        Our Value Proposition
                    </span>
                  
                    <p className="text-black text-base sm:text-lg md:text-xl p-4 sm:px-6 md:px-20 pt-3">Samadhantra unites diverse stakeholders on a single platform to turn requirements into structured, scalable, and measurable outcomes.</p>
                </div>

              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-4 sm:px-6 lg:px-16 pt-8">

  
  <div className="flex flex-col rounded-2xl bg-white shadow-lg
                  transform transition-all duration-300
                  hover:-translate-y-4 hover:scale-105">
    <div className="bg-green-300 p-4 rounded-t-2xl">
      <h3 className="font-semibold text-lg">For Individuals & Demand Creators</h3>
    </div>
    <ul className="list-disc list-outside pl-5 p-4 space-y-2 text-gray-700">
  ...
  <div className="flex flex-col rounded-2xl bg-white shadow-lg
                  transform transition-all duration-300
                  hover:-translate-y-4 hover:scale-105">
    <div className="bg-[#4facfe] p-4 rounded-t-2xl">
      <h3 className="font-semibold">For Service & Product Providers</h3>
    </div>
    <ul className="list-disc list-outside pl-5 p-4 space-y-2 text-gray-700">
  ...
  <div className="flex flex-col rounded-2xl bg-white shadow-lg
                  transform transition-all duration-300
                  hover:-translate-y-4 hover:scale-105">
    <div className="bg-[#9b59b6] p-4 rounded-t-2xl">
      <h3 className="font-semibold">For Institutions & Organizations</h3>
    </div>
    <ul className="list-disc list-outside pl-5 p-4 space-y-2 text-gray-700">
  ...
  <div className="flex flex-col rounded-2xl bg-white shadow-lg
                  ...
                  hover:-translate-y-4 hover:scale-105">
    <div className="bg-green-300 p-4 rounded-t-2xl">
      <h3 className="font-semibold">For Industry & Enterprises</h3>
    </div>
    <ul className="list-disc list-outside pl-5 p-4 space-y-2 text-gray-700">
  ...
  <div className="flex flex-col rounded-2xl bg-white shadow-lg
                  ...
                  hover:-translate-y-4 hover:scale-105">
    <div className="bg-[#4facfe] p-4 rounded-t-2xl">
      <h3 className="font-semibold">For Academia, NGOs & CSR Bodies</h3>
    </div>
    <ul className="list-disc list-outside pl-5 p-4 space-y-2 text-gray-700">
  ...
  <div className="flex flex-col rounded-2xl bg-white shadow-lg
                  ...
                  hover:-translate-y-4 hover:scale-105">
    <div className="bg-[#9b59b6] p-4 rounded-t-2xl">
      <h3 className="font-semibold">For Government & Public Sector</h3>
    </div>
    <ul className="list-disc list-outside pl-5 p-4 space-y-2 text-gray-700">
      ...
      <li>Support for policy execution, programs, and public initiatives</li>
            ...
            {/* section5 */}
            <div className=" w-full">
                <div className=" flex flex-col md:flex-row gap-8 bg-slate-50 p-4 sm:px-6 md:px-10   w-full">
    ...
    />
            ...
            <div className="flex flex-col items-center justify-center w-full pt-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-4 sm:px-6 lg:px-16 pt-8 pb-28">
            ...
            <div className="w-full pt-24 pb-20">
                <div className="container mx-auto">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:px-4 md:px-8 p-2 md:py-16 w-full">
            ...
            <div className="flex flex-col items-center justify-center p-4  w-full">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 px-4 sm:px-6 lg:px-16 pb-28">
            ...
            {/* section11 */}
            <div className="w-full">
                <div className="container mx-auto bg-[#FAF9F7] pt-28 pb-28">
                    ...
                    justify-between gap-6 p-4 sm:px-6 md:px-10 lg:px-20  w-full">
                        ...
                        <div className="md:w-1/3 text-center lg:text-right">
                            <a
                                href="#"
